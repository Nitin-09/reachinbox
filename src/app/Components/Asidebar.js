        ...
        <div className='h-screen px-1 w-14 flex flex-col items-center gap-6 border-r-[1px] border-[#D8D8D8] dark:border-[#343A40] bg-[#FAFAFA] dark:bg-[#101113]'>
            ...
            <div className='w-full h-full py-4 px-2'>
                <div className='flex flex-col justify-center items-center aspect-square w-7 gap-8'>
                    ...
                    <Image width={20} height={20} className='object-contain' src="\arrow.svg" alt=''></Image>
                    <Image width={20} height={20} className='object-contain' src="\list.svg" alt=''></Image>
                    <Image width={20} height={20} className='object-contain' src="\menu.svg" alt=''></Image>
                    <Image width={20} height={20} className='object-contain' src="\bar.svg" alt=''></Image>
                </div>
            </div>
